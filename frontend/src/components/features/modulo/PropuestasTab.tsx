    ...
    <div className="space-y-6">
      <Card className="p-6 bg-success/5 border-success/20">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="text-lg font-semibold">Propuestas de Mejora (PDCA)</h3>
          ...
          <div className="space-y-4">
            <div>
              ...
              <textarea
                ...
                className="w-full h-24 rounded-lg bg-[var(--glass-bg)] border border-[var(--glass-border)] p-3 text-sm focus:outline-none focus:border-success resize-none transition-colors"
