...
config_str = json.dumps(config_contexto_data, indent=6, ensure_ascii=False)

# Reemplazar el viejo config_contexto
new_content = re.sub(
    r'"config_contexto":\s*\{[^\}]+\}', 
...
with open(ts_file, 'w', encoding='utf-8') as f:
    f.write(new_content)
print("Injected CORRECT config_contexto into TS")
